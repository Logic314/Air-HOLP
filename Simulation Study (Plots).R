...
# Saving the plot
png("Air-HOLP vs Ridge-HOLP (p0).png",
...
# Saving the plot
png("Air-HOLP vs Ridge-HOLP (Rsq).png",
    width = 600, height = 500, pointsize = 20)
print(Bplot2)
dev.off()
...
for(plot_num in 1:2){
  ...
  if(plot_num == 1){
    Ridge50 <- c(0.892, 0.848, 0.728, 0.354)
    Ridge200 <- c(0.800, 0.772, 0.620, 0.224)
    Ridge600 <- c(0.706, 0.582, 0.386, 0.082)
  } else{
